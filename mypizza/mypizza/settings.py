...
SECRET_KEY = 'django-insecure-g3z4o%tpknbbs1l5smxnahf*7)$yxo+6f8y#cz8yp&02nus#sn'
...
ALLOWED_HOSTS = [
    'localhost:8080',
    'localhost:8000',
    'localhost:8000//api/v1/generic/list/',
    'localhost:8000/api/v1/generic/cat',
    'localhost',
    '127.0.0.1',
 ]
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'mypizza/static')
]
...
# EMAIL_PORT = 587
# EMAIL_HOST_USER = 'davidbraunn1972@gmail.com'
# EMAIL_HOST_PASSWORD = 'd123456789'

# яндекс
EMAIL_HOST = 'smtp.yandex.ru'
EMAIL_PORT = 465
EMAIL_HOST_USER = "gavrilov.serg2017@yandex.ru"
EMAIL_HOST_PASSWORD = "Dd123456789Dd"
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True
...
REST_FRAMEWORK = {
    ...
    # пагинация по умолчанию для всех элементов API REST
