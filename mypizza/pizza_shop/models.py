...
class Pizza(models.Model):
    ...
    type_product = models.ForeignKey('TypeOfProduct', on_delete=models.PROTECT, verbose_name='Тип продукта', null=True,
                                     default=1)
...
#     address = models.CharField(max_length=100, db_index=False, null=True, blank=True,
#                               verbose_name='Адрес для доставки')
#
#     def __str__(self):
#         return self.name
#
